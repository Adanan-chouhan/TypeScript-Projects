...
var mainContainer = AddCreatElement("div", "class", "mainContainer", document.body);
var calculator = AddCreatElement("div", "class", "calculator", mainContainer);
var Input = AddCreatElement("input", "class", "input", calculator);
var acBtn = AddCreatElement("button", "class", "button btn", calculator, "AC");
var delBtn = AddCreatElement("button", "class", "button btn", calculator, "DC");
var modularBtn = AddCreatElement("button", "class", "button btn", calculator, "%", "%");
var divideBtn = AddCreatElement("button", "class", "button btn", calculator, "/", "/");
var seveBtn = AddCreatElement("button", "class", "button", calculator, "7", "7");
var eightBtn = AddCreatElement("button", "class", "button", calculator, "8", "8");
var nineBtn = AddCreatElement("button", "class", "button", calculator, "9", "9");
var multiBtn = AddCreatElement("button", "class", "button btn", calculator, "*", "*");
var fourBtn = AddCreatElement("button", "class", "button", calculator, "4", "4");
var fiveBtn = AddCreatElement("button", "class", "button", calculator, "5", "5");
var sixBtn = AddCreatElement("button", "class", "button", calculator, "6", "6");
var subBtn = AddCreatElement("button", "class", "button btn", calculator, "-", "-");
var oneBtn = AddCreatElement("button", "class", "button", calculator, "1", "1");
var twoBtn = AddCreatElement("button", "class", "button", calculator, "2", "2");
var threeBtn = AddCreatElement("button", "class", "button", calculator, "3", "3");
var incrementBtn = AddCreatElement("button", "class", "button btn", calculator, "+", "+");
var zeroBtn = AddCreatElement("button", "class", "button", calculator, "0", "0");
var twpZeroBtn = AddCreatElement("button", "class", "button", calculator, "00", "00");
var dotBtn = AddCreatElement("button", "class", "button", calculator, ".", ".");
var equalBtn = AddCreatElement("button", "class", "eval button", calculator, "=");
